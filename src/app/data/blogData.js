export const blogData = [
  {
    id: 1,
    slug: "My-journey-to-becoming-a-successful-founder-and-inovator",
    title: "My Journey to Becoming a Successful Founder and Innovator",
    excerpt: "The path to founding Inovareun was filled with challenges, learning experiences, and moments of triumph. In this post, I share the key milestones and insights that shaped my journey as an entrepreneur in the tech industry.",
    date: "2026-02-09",
    tags: ["Tech story", "Entrepreneurship", "Inovareun"],
    content: `
      <p>
  <strong>April 25th, 2025</strong> — a day that started like any other but ended with a spark of inspiration. The idea of starting my own company popped into my mind. At first, I thought, "Oh, it's just another one of my wild dreams." You know, the kind that feels impossible and fades away after a while. But this time, it felt different. It felt real.


  Days went by, and I didn’t revisit the thought. I figured it was just another fleeting phase. But then, during a conversation with one of my closest friends, I casually mentioned the idea. To my surprise, she loved it! We started brainstorming names for the company, and oh boy, did we come up with some hilarious ones. One of the funniest was "BOFA" (yes, it still cracks me up to this day).

  After hours of laughing and tossing around ideas, I landed on the name "Inovaron," which means "innovation ruler/leader." It felt perfect. Unfortunately, due to some unforeseen issues, we couldn’t use that name. But we didn’t give up! We pivoted and came up with something similar: <strong>"Inovareun"</strong>, which means "innovation reunites." And just like that, the dream started to take shape.

  <img src="/logo.png" alt="Inovareun logo brainstorming" class="my-4 rounded-lg shadow-md" />

  <strong>June 16th, 2025</strong> — the day Inovareun was officially born. Fully registered, with a team of passionate employees and a shiny new website (<a href="https://www.inovareun.com" target="_blank">https://www.inovareun.com</a>), we were ready to take on the world. I still remember the joy of landing our first gig, it was a moment of pure triumph.
